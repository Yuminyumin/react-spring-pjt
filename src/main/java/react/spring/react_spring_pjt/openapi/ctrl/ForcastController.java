...
public class ForcastController {
    ...
    public ResponseEntity<Object> validateForecastApi(@Valid
                                                      @RequestBody
                                                      ForecastRequestDTO params,
                                                      BindingResult bindingResult) {

        System.out.println("client end point : /api/validate/forecast");
        ...
        // step 01) 스프링에서 제공되는 콜백URL에 요청 파라미터를 보내는 것
        ...
        try{
            ...
            if(code ==200){
                ...
                result = readString(stream);// 내가 만든 메서드
    ...
    public ResponseEntity<List<ForecastItemDTO>> reactForecastApi(
        ...
        System.out.println("client end point : /api/react/forecast");
        System.out.println("serviceKey = " +serviceKey);
        System.out.println("callBackUrl = " +callBackUrl);
        System.out.println("dataType = " +dataType);
